...
def main():
    ...
    parser_init = subparsers.add_parser('initiate', help='Initiate a project', parents=[common_parser])
    ...
    if args.workflow == "initiate":
            ...
            shutil.copy(Path(__file__).parents[1] / 'templates/template_nets.py', (project_name / 'models').as_posix())
